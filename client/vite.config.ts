...
export default defineConfig({
  ...
  server: {
    ...
    fs: {
      ...
      allow: ['.'],
      // Deny access to files outside project root
      deny: ['..'],
      // Apply strict mode for additional security
      strict: true,
    },
  },
  // Security: Prevent serving files from public directory that conflict with source files
  publicDir: 'public',
  define: {
