  ...
  const fetchAnalytics = async (isInitialLoad: boolean = false) => {
    try {
      ...
      if (data.success && data.data) {
        ...
        // - Completed: Green (foodbank.green) - Collected/Shipped
        // - Pending: Teal Green (foodbank.blue) - Pending/Rescheduled (future appointments that haven't happened yet)
        // - No Show: Red (foodbank.coral) - Not Collected/Cancelled (missed appointments)
        ...
        >
          <VStack spacing={4} align="start">
            <Box textAlign="center" w="full">
              <Text fontWeight="bold" fontSize="lg" color="foodbank.blue" mb={1}>
                {label}
              </Text>
              <Text fontSize="sm" color="foodbank.blue">
                Appointment Summary
              </Text>
            </Box>
            ...
            <HStack spacing={4} justify="center" w="full">
              ...
              <VStack align="center" spacing={2} minW="70px">
                ...
                <Text fontSize="xs" color="foodbank.blue" fontWeight="600" textAlign="center">
                  📅 Pending
                </Text>
              </VStack>
              ...
              <VStack align="center" spacing={2} minW="70px">
                ...
                <Text fontSize="xs" color="foodbank.coral" fontWeight="600" textAlign="center">
                  ❌ No Show
                </Text>
              </VStack>
            </HStack>
            ...
            {total > 0 && (
              ...
              >
                <Text fontSize="sm" color="gray.700" fontWeight="medium">
                  Total Appointments: <Text as="span" fontWeight="bold" color="foodbank.blue">{total}</Text>
                </Text>
              </Box>
            )}
          </VStack>
        ...
        <Grid templateColumns={{ base: '1fr', sm: 'repeat(2, 1fr)', md: 'repeat(4, 1fr)' }} gap={{ base: 3, sm: 4, md: 4 }}>
          <GridItem>
            <Box 
              ...
              borderRadius="xl" 
              border="2px solid" 
              borderColor={hasNoData ? "gray.200" : "foodbank.blue"} 
              boxShadow={hasNoData ? "sm" : "lg"}
              transition="all 0.2s"
            >
              <VStack spacing={2}>
                <Text fontSize={{ base: "xs", sm: "sm" }} color={hasNoData ? "neutral.500" : "foodbank.blue"} fontWeight="600">
                  📅 Total Appointments
                </Text>
                <Text fontSize={{ base: "xl", sm: "2xl" }} color={hasNoData ? "neutral.400" : "foodbank.blue"} fontWeight="bold">
                  {stats.totalCheckIns}
                </Text>
                <Text fontSize={{ base: "xs", sm: "xs" }} color={hasNoData ? "neutral.400" : "foodbank.blue"}>
          ...
          <GridItem>
            <Box 
              ...
              borderRadius="xl" 
              border="2px solid" 
              borderColor={hasNoData ? "gray.200" : "foodbank.green"} 
              boxShadow={hasNoData ? "sm" : "lg"}
              transition="all 0.2s"
            >
              <VStack spacing={2}>
                <Text fontSize={{ base: "xs", sm: "sm" }} color={hasNoData ? "neutral.500" : "foodbank.green"} fontWeight="600">
                  ✅ Completed Check-ins
                </Text>
                <Text fontSize={{ base: "xl", sm: "2xl" }} color={hasNoData ? "neutral.400" : "foodbank.green"} fontWeight="bold">
                  {stats.completed}
                </Text>
                <Text fontSize={{ base: "xs", sm: "xs" }} color={hasNoData ? "neutral.400" : "foodbank.green"}>
          ...
          <GridItem>
            <Box 
              ...
              borderRadius="xl" 
              border="2px solid" 
              borderColor={hasNoData ? "gray.200" : "foodbank.coral"} 
              boxShadow={hasNoData ? "sm" : "lg"}
              transition="all 0.2s"
            >
              <VStack spacing={2}>
                <Text fontSize={{ base: "xs", sm: "sm" }} color={hasNoData ? "neutral.500" : "foodbank.coral"} fontWeight="600">
                  ❌ No Show Appointments
                </Text>
                <Text fontSize={{ base: "xl", sm: "2xl" }} color={hasNoData ? "neutral.400" : "foodbank.coral"} fontWeight="bold">
                  {stats.noShow}
                </Text>
                <Text fontSize={{ base: "xs", sm: "xs" }} color={hasNoData ? "neutral.400" : "foodbank.coral"}>
        ...
        >
          ...
          <VStack spacing={6} align="stretch" position="relative" zIndex={1}>
            <Box textAlign="center">
              ...
              <Text fontSize={{ base: "sm", sm: "md", md: "md" }} color="admin.primary" fontWeight="medium">
            ...
            <Box 
              ...
              _before={{
                ...
                right: 0,
                height: '4px',
                background: 'linear-gradient(90deg, foodbank.green, foodbank.blue, foodbank.orange)',
                ...
                >
                  ...
                  <defs>
                    <linearGradient id="completedGradient" x1="0" y1="0" x2="0" y2="1">
                      <stop offset="0%" stopColor="#6B9F7A" />
                      <stop offset="50%" stopColor="#5D8C6A" />
                      <stop offset="100%" stopColor="#4F795A" />
                    </linearGradient>
                    <linearGradient id="pendingGradient" x1="0" y1="0" x2="0" y2="1">
                      <stop offset="0%" stopColor="#4A6B8C" />
                      <stop offset="50%" stopColor="#3C5670" />
                      <stop offset="100%" stopColor="#3C5670" />
                    </linearGradient>
                    <linearGradient id="noShowGradient" x1="0" y1="0" x2="0" y2="1">
                      <stop offset="0%" stopColor="#D85A4A" />
                      <stop offset="50%" stopColor="#C24D3E" />
                      <stop offset="100%" stopColor="#AC4032" />
                    </linearGradient>
                    <filter id="glow">
                  ...
                  <XAxis 
                    ...
                    axisLine={{ stroke: 'foodbank.blue', strokeWidth: 2 }}
                    tickLine={{ stroke: 'foodbank.blue', strokeWidth: 1 }}
                    angle={-45}
                    textAnchor="end"
                    height={120}
