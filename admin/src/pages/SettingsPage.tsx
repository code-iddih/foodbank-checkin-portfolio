            ...
            <Card bg="white" border="1px solid" borderColor="gray.200" borderRadius="lg" boxShadow="sm">
              <CardBody p={6}>
                <Stat>
                  ...
                  <StatNumber color="admin.primary" fontSize="2xl">
                  ...
                  <VStack spacing={6} align="stretch">
                    <HStack justify="space-between" align="center">
                      <HStack spacing={3}>
                        ...
                        >
                          <Icon as={FiLink} color="admin.primary" boxSize={5} />
                        </Box>
                  ...
                  <VStack spacing={4} align="stretch">
                    <HStack spacing={3}>
                      <Box
                        ...
                        justifyContent="center"
                      >
                        <Icon as={FiSettings} color="admin.primary" boxSize={5} />
                      </Box>
                      <VStack spacing={0} align="start">
                        <Heading size="md" color="admin.primary">
                          System Configuration
                  ...
                  <VStack spacing={4} align="stretch">
                    <HStack spacing={3}>
                      <Box
                        ...
                        justifyContent="center"
                      >
                        <Icon as={FiShield} color="admin.primary" boxSize={5} />
                      </Box>
                      <VStack spacing={0} align="start">
                        <Heading size="md" color="admin.primary">
                          Security
