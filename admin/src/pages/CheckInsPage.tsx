        ...
        >
          ...
          <Box 
            ...
            _before={{
              ...
              right: 0,
              height: '4px',
              background: 'foodbank.green',
              borderRadius: '2xl 2xl 0 0',
            }}
          >
            <VStack align="center" spacing={3}>
              <Text fontSize="3xl" fontWeight="bold" color="foodbank.green">
          ...
          >
            <VStack align="center" spacing={3}>
              <Text fontSize="3xl" fontWeight="bold" color="foodbank.blue">
          ...
          <Box 
            ...
            _before={{
              ...
              right: 0,
              height: '4px',
              background: 'foodbank.orange',
              borderRadius: '2xl 2xl 0 0',
            }}
          >
            <VStack align="center" spacing={3}>
              <Text fontSize="3xl" fontWeight="bold" color="foodbank.orange">
                  ...
                  <HStack spacing={4} align="start">
                    ...
                    <VStack align="start" spacing={2} flex={1}>
                      <HStack spacing={3} wrap="wrap">
                        ...
                        {checkIn.hasMobilityIssues && (
                          <Tooltip label="Mobility Assistance Required" placement="top">
                            <Box color="foodbank.orange" cursor="help" fontSize="16px">
                              ♿
                            </Box>
                          </Tooltip>
                        )}
                      ...
                      <HStack spacing={4} wrap="wrap">
                        <HStack spacing={1}>
                          <FiClock size={14} color="gray.500" />
                      ...
                      <Grid templateColumns="repeat(2, 1fr)" gap={4}>
                        ...
                        <VStack align="start" spacing={2}>
                          ...
                          {selectedCheckIn.hasMobilityIssues && (
                            <Text color="foodbank.orange"><strong>♿ Mobility Assistance Required</strong></Text>
                          )}
                        </VStack>
                      </Grid>
                    </CardBody>
