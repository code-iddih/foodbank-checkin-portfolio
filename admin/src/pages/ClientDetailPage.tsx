...
const ClientDetailPage: React.FC = () => {
   ...
   * 
   * Security: Now uses authenticated API requests for secure ticket access.
   */
  const handlePrint = () => {
    if (!id || !client) return;
    ...
    <Container maxW="container.md" py={8}>
      <VStack spacing={6} align="stretch">
        ...
        <VStack spacing={4} align="stretch">
          <Heading size="md" color="admin.primary">Client Extras</Heading>
