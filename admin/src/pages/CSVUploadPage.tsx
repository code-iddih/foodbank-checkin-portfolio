...
const CSVUploadPage: React.FC = () => {
  ...
  const handleDownloadSample = () => {
    // Generate sample CSV with today's date automatically populated
    // Uses clearly fake/test data for demonstration purposes
...
10001,Test Client One,${today} @ 9:00 AM,None,Standard Hamper,2,0,1,"5",test.client1@example.com,(250) 555-0101
10002,Test Client Two,${today} @ 9:15 AM,Vegetarian,Standard Hamper,1,1,0,,test.client2@example.com,(250) 555-0102
10003,Test Client Three,${today} @ 9:30 AM,Gluten-Free,Standard Hamper,1,0,2,"3,7",test.client3@example.com,(250) 555-0103
10004,Test Client Four,${today} @ 9:45 AM,Halal,Standard Hamper,3,0,0,,test.client4@example.com,(250) 555-0104
10005,Test Client Five,${today} @ 10:00 AM,None,Standard Hamper,1,0,1,"4",test.client5@example.com,(250) 555-0105
10006,Test Client Six,${today} @ 10:15 AM,Dairy-Free,Standard Hamper,2,1,0,,test.client6@example.com,(250) 555-0106`;
  ...
  return (
    <VStack spacing={6} align="stretch">
          ...
          >
            <VStack spacing={4} h="full" justify="center">
              <Box
                ...
                display="inline-flex"
              >
                <Icon as={FiCalendar} color="foodbank.blue" boxSize={6} />
              </Box>
              <VStack spacing={2}>
                <Text fontSize="sm" color="foodbank.blue" fontWeight="600" textTransform="uppercase" letterSpacing="wide">
                  Today's Date
                </Text>
        ...
        <GridItem>
          <Box 
            ...
            _before={{
              ...
              right: 0,
              height: '4px',
              background: getStatusColor() === 'green' ? 'foodbank.green' : 'foodbank.coral',
              borderRadius: '2xl 2xl 0 0',
            }}
          >
            <VStack spacing={4} h="full" justify="center">
              <Box
                bg={getStatusColor() === 'green' ? 'foodbank.green' : 'foodbank.coral'}
                color="white"
                borderRadius="xl"
                p={4}
                display="inline-flex"
              >
                <Icon as={FiDatabase} color={getStatusColor() === 'green' ? 'foodbank.green' : 'foodbank.coral'} boxSize={6} />
              </Box>
              <VStack spacing={2}>
                <Text fontSize="sm" color={getStatusColor() === 'green' ? 'foodbank.green' : 'foodbank.coral'} fontWeight="600" textTransform="uppercase" letterSpacing="wide">
                  Data Status
                </Text>
                <Text fontSize="xl" fontWeight="bold" color="admin.primary">
                  {getStatusText()}
          ...
          <Box bg="white" borderRadius="lg" boxShadow="sm" border="1px solid" borderColor="gray.200" p={5} textAlign="center" h="full">
            <VStack spacing={3} h="full" justify="center">
              <Box
                ...
                display="inline-flex"
              >
                <Icon as={FiDatabase} color="foodbank.blue" boxSize={5} />
              </Box>
              <VStack spacing={1}>
                <Text fontSize="xs" color="foodbank.blue" fontWeight="600" textTransform="uppercase" letterSpacing="wide">
                  Client Appointments Loaded
                </Text>
                {loading ? (
                  <Spinner size="md" color="admin.primary" />
                ) : error ? (
                  <Text color="foodbank.coral" fontSize="sm">Error</Text>
                ) : (
                ...
                {status?.data.present && status.data.expiresAt && (
                  <Text color="foodbank.orange" fontSize="xs">
          ...
          <Box bg="white" borderRadius="lg" boxShadow="sm" border="1px solid" borderColor="gray.200" p={5} textAlign="center" h="full">
            <VStack spacing={3} h="full" justify="center">
              <Box
                ...
                display="inline-flex"
              >
                <Icon as={FiUpload} color="foodbank.green" boxSize={5} />
              </Box>
              <VStack spacing={1}>
                <Text fontSize="xs" color="foodbank.green" fontWeight="600" textTransform="uppercase" letterSpacing="wide">
                  System Status
                </Text>
          ...
          <Box bg="white" borderRadius="lg" boxShadow="sm" border="1px solid" borderColor="gray.200" p={5} h="full">
            <VStack spacing={3} h="full" justify="center">
              <Box
                ...
                display="inline-flex"
              >
                <Icon as={FiRefreshCw} color="foodbank.blue" boxSize={5} />
              </Box>
      ...
      {/* Main Upload Section */}
      <Box bg="white" borderRadius="xl" boxShadow="lg" border="2px solid" borderColor="admin.primary" overflow="hidden">
        <Box 
          bg="admin.primary"
          color="white"
          textAlign="center"
